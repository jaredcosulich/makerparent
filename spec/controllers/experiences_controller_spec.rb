  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved experience as @experience" do
        ...
        post :create, {:experience => { "summary" => "invalid value" }}, valid_session
        assigns(:experience).should be_a_new(Experience)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested experience" do
        ...
        Experience.any_instance.should_receive(:update).with({ "summary" => "MyString" })
        put :update, {:id => experience.to_param, :experience => { "summary" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the experience as @experience" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Experience.any_instance.stub(:save).and_return(false)
        put :update, {:id => experience.to_param, :experience => { "summary" => "invalid value" }}, valid_session
        assigns(:experience).should eq(experience)
      end
